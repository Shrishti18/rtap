...
hdr=f"{'case':>6} {'band':>4} {'M_trg':>7} {'M':>7} {'lam':>6} {'W':>6} {'d_iso':>6} {'unif':>6} | {'U_req':>6} {'iso_req':>7} {'Mreq':>6} | {'iso':>4} {'M':>4} {'unif':>4}"
...
for tag in ['M0.0','M0.9']:
    ...
    for b,W,iso in harvest.auto_bands(Hk,wmax=10.0,iso_min=0.0):
        ...
        print(f"{tag:>6} {b:>4} {ds['M_trg']:7.4f} {ds['M']:7.3f} {ds['lam']:6.3f} {ds['W']:6.2f} {ds['d_iso']:6.2f} {ds['unif']:6.3f} | "
              f"{sp['U_req']:6.3f} {sp['iso_req']:7.3f} {sp['M_req_trg']:6.3f} | "
